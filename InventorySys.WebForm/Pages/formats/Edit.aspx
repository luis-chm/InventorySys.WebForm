<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Menu.Master"  AutoEventWireup="true" CodeBehind="Edit.aspx.cs" Inherits="InventorySys.WebForm.Pages.Formats.Edit" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     ...
     <div class="container-fluid">
         ...
         <div class="row">
             <div class="col-sm-6">
                 <h3 class="mb-0">Editar Formato</h3>
             </div>
             <div class="col-sm-6">
                 <ol class="breadcrumb float-sm-end">
                     <li class="breadcrumb-item"><a href="/Pages/Formats/Formats.aspx">Formats</a></li>
                     <li class="breadcrumb-item active" aria-current="page">Editar Formato</li>
                 </ol>
             </div>
             <!-- /.Start col -->
         </div>
