<%@ Page Title="" Language="C#" MasterPageFile="~/Pages/Menu.Master" AutoEventWireup="true" CodeBehind="Formats.aspx.cs" Inherits="InventorySys.WebForm.Pages.Formats.Formats" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="app-content-header">
        ...
        <div class="container-fluid">
            ...
            <div class="row">
                <div class="col-sm-6">
                    <h3 class="mb-0">Formatos</h3>
                </div>
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-end">
                        <li class="breadcrumb-item"><a href="/Pages/Inicio">Home</a></li>
                        <li class="breadcrumb-item active" aria-current="page">Formats</li>
                    </ol>
                </div>
                <!-- /.Start col -->
            </div>
    ...
    <div class="card">
        <div class="card-body">
            <div style="margin-left: 15px;">
                ...
                <div class="row">
                    <div class="col-11">
                        <asp:GridView ID="gvFormats" CssClass="table table-bordered dataTables1" runat="server" AutoGenerateColumns="False" class="table table-bordered">

                            <Columns>
                                <asp:BoundField DataField="FormatID" HeaderText="ID de formato" />
                                <asp:BoundField DataField="FormatName" HeaderText="Nombre de formato" />
                                <asp:BoundField DataField="FormatSizeCM" HeaderText="Tamaño de formato" />                                                           
                                <asp:TemplateField HeaderText="Estado de formato">
                                    <ItemTemplate>
                                        <span class='<%# Convert.ToBoolean(Eval("FormatActive")) ? "bi bi-check-circle text-success" : "bi bi-x-circle text-danger" %>'></span>
                                          <%# Convert.ToBoolean(Eval("FormatActive")) ? "Activo" : "Inactivo" %>
                                    </ItemTemplate>
                                </asp:TemplateField>
